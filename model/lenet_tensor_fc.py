...
class LeNet5_Mnist_Tensor_NANNAN(nn.Module):
    def __init__(self, num_classes=10, RANK=None):
        super(LeNet5_Mnist_Tensor_NANNAN, self).__init__()
        ...
        self.s2 = nn.MaxPool2d(kernel_size=(2, 2), stride=2)
        self.c3 = TensorRingConvolution([Rank[4], Rank[5], Rank[6]], [2, Rank[8]], [4, 5], [5, 10], kernel_size=5)
...
class LeNet5_Fashion_Mnist_Tensor(nn.Module):
    def __init__(self, num_classes=10, RANK=None):
        super(LeNet5_Fashion_Mnist_Tensor, self).__init__()
        ...
        self.fc5 = TensorRingLinear(1250, 320, [5, 5, 5, 10], [5, 8, 8], [RANK[0], RANK[1], RANK[2], RANK[3], RANK[4], RANK[5], RANK[6]])
        self.fc6 = nn.Linear(320, num_classes)
